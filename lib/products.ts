...
export const products: Product[] = [
  ...
  { id: 'gathinja-dark', name: 'Gathinja Dark Roast', slug: 'gathinja-dark-roast', origin: "Murang'a", roast: 'Dark', process: 'Washed', flavorProfile: ['Cocoa', 'Brown Sugar', 'Sweet Lemon Zest'], description: "A deeper Murang'a roast with a full body and a sweet finish, made for lingering conversations.", weightG: 400, priceKsh: 1250, imageUrl: '/grounds-brew.jpg', stock: 50 },
]
